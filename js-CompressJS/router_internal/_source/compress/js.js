//----------------------------------------------------------------------------------------------------;
var fileNm = "js-CompressJS/router_internal/_source/compress/js.js";
 ...
 * @example
 * <code>
	http://localhost:port/_source/compress/js?data=var a = 1;
 * </code>
 */
(function( req, res ){
	//global.TtwLog.log( "- [ S ] - _source/compress/js():void----------" );
	...
	global.b2link.router_file.post_ReceiveData__String( req, res, function( req, res, data ){
		...
		try
		{
			...
			srcMin = global.compressJS.compress__js_code( data, {} );
		}
		catch( e )
		{
