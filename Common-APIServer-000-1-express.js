...
var cwd = global.process.cwd() + "/";
//try{if(global._$TATIC_CONST_DEBUG){global.Lib.Ttw.autoLoad_JS.addJSFiles___Define(cwd+"../"+p0+"js-WebServer/",{router:1,router_external:1,router_internal:1});global.Lib.Ttw.autoLoad_JS.addJSFiles_Package(cwd+"../"+p0+"js-WebServer/",{router:1,router_external:1,router_internal:1});}else require(cwd+"../"+p0+"js-WebServer__Merge/___merge_min_all_1_0.js" );}catch(e){}
try{if(global._$TATIC_CONST_DEBUG){global.Lib.Ttw.autoLoad_JS.addJSFiles___Define(cwd+"../../"+p0+"js/",{router:1,router_external:1,router_internal:1});global.Lib.Ttw.autoLoad_JS.addJSFiles_Package(cwd+"../../"+p0+"js/",{router:1,router_external:1,router_internal:1});}else require(cwd+"../../"+p0+"js__Merge/___merge_min_all_1_0.js");}catch(e){}
try{if(global._$TATIC_CONST_DEBUG){global.Lib.Ttw.autoLoad_JS.addJSFiles___Define(cwd+"../"+p0+"js/",{router:1,router_external:1,router_internal:1});global.Lib.Ttw.autoLoad_JS.addJSFiles_Package(cwd+"../"+p0+"js/",{router:1,router_external:1,router_internal:1});}else require(cwd+"../"+p0+"js__Merge/___merge_min_all_1_0.js");}catch(e){}
var f=global.Lib.Ttw.autoLoad_JS.addRouter__JSFiles_Services;

	try{f(cwd+"../../"+p0+"js/router/");f(cwd+"../../"+p0+"js/router_external/");f(cwd+"../../"+p0+"js/router_internal/");}catch( e ){}
	try{f(cwd+"../"+p0+"js/router/");f(cwd+"../"+p0+"js/router_external/");f(cwd+"../"+p0+"js/router_internal/");}catch( e ){}
	//f(cwd+"./js/router_external/");
	//f(cwd+"./js/router_internal/");
//----------------------------------------------------------------------------------------------------;
	/*/
	f(cwd+"../../"+p0+"js-CompressJS/router/");
	f(cwd+"../../"+p0+"js-CompressJS/router_external/");
	f(cwd+"../../"+p0+"js-CompressJS/router_internal/");
	//*/

	//*/
	try
	{
		f(cwd+"../../"+p0+"js-File/router/");
		//f(cwd+"../../"+p0+"js-File/router_external/");//f(cwd+"../../"+p0+"js-File/router_internal/");
	}
	catch( e )
	{
		try
	...
	/*/
	f(cwd+"../../"+p0+"js-Source/router/");
	f(cwd+"../../"+p0+"js-Source/router_external/");
	f(cwd+"../../"+p0+"js-Source/router_internal/");
	//*/

	//*/
	try{ f(cwd+"../../"+p0+"js-UncompressSource/router/");f(cwd+"../../"+p0+"js-UncompressSource/router_external/");f(cwd+"../../"+p0+"js-UncompressSource/router_internal/"); }catch( e ){}
	try{ f(cwd+"../"+p0+"js-UncompressSource/router/");f(cwd+"../"+p0+"js-UncompressSource/router_external/");f(cwd+"../"+p0+"js-UncompressSource/router_internal/"); }catch( e ){}
	//*/
//----------------------------------------------------------------------------------------------------;
