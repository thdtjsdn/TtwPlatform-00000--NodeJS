//----------------------------------------------------------------------------------------------------;
//var fileNm = "js-WebServer/b2link_router/__define/101_define_global.router.STATIC.CONFIG.js";
...
global.router.STATIC.CONFIG.URL = global.router.STATIC.CONFIG.URL || {};
global.router.STATIC.CONFIG.URL._COMMON = "http://localhost:49320/";//시스템 개별 정의;

global.router.STATIC.CONFIG.URL.MEMBER = global.router.STATIC.CONFIG.URL.MEMBER || {};
global.router.STATIC.CONFIG.URL.MEMBER.COMMON = global.router.STATIC.CONFIG.URL._COMMON + "member/";

global.router.STATIC.CONFIG.URL.MEMBER.MEMBER_SESSION = global.router.STATIC.CONFIG.URL.MEMBER.MEMBER_SESSION || {};
/*/
