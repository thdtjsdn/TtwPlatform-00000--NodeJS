...
//----------------------------------------------------------------------------------------------------;
	...
	//*/
	try{ f("../"+p0+"js-UncompressSource/router/"); }catch(er){}
	try{ f("../"+p0+"js-UncompressSource/router_external/"); }catch(er){}
	try{ f("../"+p0+"js-UncompressSource/router_internal/"); }catch(er){}
	//*/
//----------------------------------------------------------------------------------------------------;
