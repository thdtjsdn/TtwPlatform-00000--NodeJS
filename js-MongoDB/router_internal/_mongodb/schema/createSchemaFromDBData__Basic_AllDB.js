 ...
 * <code>
	...
	global.b2link.request.get( "http://localhost:30000/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:49320/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:45320/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:45420/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:45520/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:49322/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:42322/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:46320/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:44320/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
	global.b2link.request.get( "http://localhost:43320/_mongodb/schema/createSchemaFromDBData__Basic_AllDB
...
(function( req, res ){
	...
	global.server.req_DB( req, res, { db : "admin", q : 'return db.getSiblingDB( "_instance" ).cols.find({}).toArray();' }, function( error, result ){
		...
		var f0 = global.b2link.request.get;
		...
		for( ; i<iLen; ++i )
		{
			...
			f0( global.b2link.url.getServerURL_APIServer_Self() + '/_mongodb/schema/createSchemaFromDBData__Basic_Collection?data={"nm_db":"' + io.db + '","nm_col":"' + io._id + '"}', fn );

			console.log( global.b2link.url.getServerURL_APIServer_Self() + '/_mongodb/schema/createSchemaFromDBData__Basic_Collection?data={"nm_db":"' + io.db + '","nm_col":"' + io._id + '"}' );
		}
