//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_update/updateMany.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.update + "updateMany.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_update/updateMany?data={ db : "", col : "", filter : {}, update : {}, options : {} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_update/updateMany():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.update + "updateMany.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_update/updateMany():void----------" );
});