//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_update/updateOne.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.update + "updateOne.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_update/updateOne?data={ db : "", col : "", filter : {}, update : {}, options : {} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_update/updateOne():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.update + "updateOne.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_update/updateOne():void----------" );
});