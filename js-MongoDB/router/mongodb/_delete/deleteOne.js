//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_delete/deleteOne.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.delete + "deleteOne.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_delete/deleteOne?data={ db : "", col : "", filter : {}, options : {} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_delete/deleteOne():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.delete + "deleteOne.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_delete/deleteOne():void----------" );
});