//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_delete/deleteMany.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.delete + "deleteMany.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_delete/deleteMany?data={ db : "", col : "", filter : {}, options : {} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_delete/deleteMany():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.delete + "deleteMany.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_delete/deleteMany():void----------" );
});