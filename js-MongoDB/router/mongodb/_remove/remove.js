//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_remove/remove.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.remove + "remove.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_remove/remove?data={ db : "", col : "", t : {}, justOne : {Boolean} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_remove/remove():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.remove + "remove.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_remove/remove():void----------" );
});