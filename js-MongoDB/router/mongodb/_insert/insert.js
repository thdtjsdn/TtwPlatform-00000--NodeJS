//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_insert/insert.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.insert + "insert.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_insert/insert?data={ db : "", col : "", obj : {}, options : {}, _allow_dot : {Boolean} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_insert/insert():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.insert + "insert.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_insert/insert():void----------" );
});