//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_insert/insertMany.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.insert + "insertMany.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_insert/insertMany?data={ db : "", col : "", documents : [], options : {} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_insert/insertMany():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.insert + "insertMany.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_insert/insertMany():void----------" );
});