//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_insert/insertOne.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.insert + "insertOne.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_insert/insertOne?data={ db : "", col : "", document : {}, options : {} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_insert/insertOne():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.insert + "insertOne.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_insert/insertOne():void----------" );
});