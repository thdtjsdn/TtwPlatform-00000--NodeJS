//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_find/find.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.find + "find.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_find/find?data={ db : "", col : "", query : {}, fields : {}, limit : {Uint}, skip : {Uint}, batchSize : {Uint}, options : {} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_find/find():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.find + "find.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_find/find():void----------" );
});