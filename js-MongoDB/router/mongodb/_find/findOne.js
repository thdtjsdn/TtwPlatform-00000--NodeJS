//----------------------------------------------------------------------------------------------------;
var fileNm = "js-MongoDB/router/mongodb/_find/findOne.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( global.router.mongodb.PATH.find + "fineOne.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:port/mongodb/_find/fineOne?data={ db : "", col : "", query : {}, fields : {}, options : {}, readConcern : {}, collation : {} }
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - mongodb/_find/fineOne():void----------" );
	...
	global.b2link.fs.writeQuery( global.router.mongodb.PATH.find + "fineOne.query", query );
	...
	global.TtwLog.log( "- [ E ] - mongodb/_find/fineOne():void----------" );
});