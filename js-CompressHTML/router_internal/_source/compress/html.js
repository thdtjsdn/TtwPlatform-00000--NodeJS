//----------------------------------------------------------------------------------------------------;
var fileNm = "js-CompressHTML/router_internal/_source/compress/html.js";
 ...
 * @example
 * <code>
	http://localhost:port/_source/compress/html?data=var a = 1;
 * </code>
 */
(function( req, res ){
	//global.TtwLog.log( "- [ S ] - _source/compress/html():void----------" );
	...
	if( !global.compressHTML ) global.b2link.compressHTML.install();
	...
	global.b2link.router_file.post_ReceiveData__String( req, res, function( req, res, data ){
		...
		try
		{
			...
			srcMin = global.compressHTML.compress__html_code( data );
		}
		catch( e )
		{
	...
	//global.TtwLog.log( "- [ E ] - _source/compress/html():void----------" );
});